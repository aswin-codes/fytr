...
const BodyMetricsCard = () => {
  ...
  const { weight, height, targetWeight, age, setAge, setWeight, setHeight, setTargetWeight } = useOnboardingStore();
    ...
    <ScrollView className="flex-1 bg-background-light dark:bg-background-dark" showsVerticalScrollIndicator={false}>
      <View className="p-6" style={{ width }}>
        <Text
          ...
          className="mb-6 text-2xl text-textPrimary-light dark:text-textPrimary-dark"
        >
          Your body details
        </Text>
        ...
        <View className="mb-4">
          ...
          <View className="relative">
            ...
            <Text
              style={{ fontFamily: fontFamily.medium }}
              className="absolute right-4 top-4 text-xl text-textSecondary-light dark:text-textSecondary-dark"
            >
              yrs
            </Text>
          </View>
        ...
        <View className="mb-6 flex-row gap-3">
          {/* Current BMI */}
          <View className="flex-1 items-center rounded-3xl bg-card-light dark:bg-card-dark p-6 shadow-sm">
            <Text
              style={{ fontFamily: fontFamily.regular }}
              className="mb-2 text-center text-xs uppercase tracking-wider text-textSecondary-light dark:text-textSecondary-dark"
            >
              YOUR BMI
            </Text>
            <Text
              style={{ fontFamily: fontFamily.bold }}
              className="mb-2 text-5xl text-textPrimary-light dark:text-textPrimary-dark"
            >
              {currentBMI || '--'}
            </Text>
            {currentBMI && (
              ...
              >
                <Text
                  style={{
                    ...
                    color: currentBMICategory.textColor,
                  }}
                  className="text-xs"
                >
            ...
            <Text
              style={{ fontFamily: fontFamily.regular }}
              className="text-center text-xs text-textSecondary-light dark:text-textSecondary-dark"
            >
              Based on your{'\n'}height & weight
            </Text>
          </View>
            ...
            {targetBMI && (
              ...
              >
                <Text
                  style={{
                    fontFamily: fontFamily.semiBold,
                    color: targetBMICategory.textColor,
                  }}
                  className="text-xs"
                >
        ...
        {/* BMI Reference Guide */}
        <View className="rounded-3xl bg-card-light rounded-lg dark:bg-card-dark p-6">
          <Text
            style={{ fontFamily: fontFamily.semiBold }}
            className="mb-4 text-base text-textPrimary-light dark:text-textPrimary-dark"
          >
            BMI Reference
          </Text>
