import { createUserWithEmailAndPassword, getAuth, GoogleAuthProvider, onAuthStateChanged, sendPasswordResetEmail, signInWithCredential, signInWithEmailAndPassword, signOut, updateProfile, User, verifyBeforeUpdateEmail } from "firebase/auth";
...
export function AuthProvider({children} : any) {
    ...
    useEffect(() => {
        ...
        GoogleSignin.configure({
            webClientId: "483871924522-gv00gr4seaqua0vm20b8miqtrua75v31.apps.googleusercontent.com"
        })
